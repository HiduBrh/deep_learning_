...
x_train = pickle.load(open('x_train_padding.txt','rb'))
x_test = pickle.load(open('x_test_paddingf.txt','rb'))
y_train = pickle.load(open('y_train.txt','rb'))
y_test = pickle.load(open('y_test.txt','rb'))

tb_callback = TensorBoard("C:/Project/kerasTest/Logs/cats_dogs_convolution_padding/")
